...
# print(settlement)
print(settlement_rate.tail(4))
surveySettlementRates = pd.DataFrame({'meanSettlement': settlement_rate.mean(axis = 1), 'stdSettlement': settlement_rate.std(axis = 1)})
columnSettlementRates = pd.DataFrame({'meanSettlement': settlement_rate.tail(4).mean(axis = 0), 'stdSettlement': settlement_rate.tail(4).std(axis = 0)})
#surveySettlementRates.tail(13).to_csv('C:/Users/RDCRLWKR/Documents/FileCloud/My Files/Active Projects/NSF USAP/South Pole Foundation/Technical/Figures/SettlementRateSurvey.csv')
#settlement_rate.tail(4).to_csv('C:/Users/RDCRLWKR/Documents/FileCloud/My Files/Active Projects/NSF USAP/South Pole Foundation/Technical/Figures/SettlementRatelast.csv')
# stationAvg = recentSettlement.mean()
# stationSD =  recentSettlement.std()
#print(recentSettlement)
print(columnSettlementRates)